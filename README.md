...
The complete source code developed for this thesis—including the computer vision pipeline, the hardware telemetry integration, and the web-based user interface—is publicly available. The repository also contains the 3D CAD models (STL files) designed for the custom device enclosure. 
